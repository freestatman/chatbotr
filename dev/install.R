# Installation Script for R Chatbot# Installation Script for R Chatbot
...
if (!requireNamespace("pak", quietly = TRUE)) {
  cat(
    "Installing 'pak' package for fast and reliable package installation...\n"
  )
  install.packages("pak")
}

# Install CRAN packages using pak
cat("Installing required CRAN packages with pak...\n")
for (pkg in cran_packages) {
  if (!requireNamespace(pkg, quietly = TRUE)) {
    cat(paste("Installing", pkg, "with pak...\n"))
    pak::pkg_install(pkg)
  } else {
...
cat("\nInstalling optional packages with pak...\n")
...
#   pak::pkg_install(paste0(gh$repo, "@", gh$ref))
# }
